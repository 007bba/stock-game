...
- [x] P7-T1：初始化 React 项目 + Vite + TypeScript
- [x] P7-T2：集成 Ant Design + 路由配置
- [x] P7-T3：实现登录/注册页面（mock 数据）
- [x] P7-T4：实现赛季大厅页面
- [x] P7-T5：实现交易界面布局（三栏式）
- [x] P7-T6：集成 Lightweight Charts 绘制 K 线
- [x] P7-T7：实现下单表单（买入/卖出 tab）
- [x] P7-T8：实现订单簿组件（买卖盘）
- [x] P7-T9：实现持仓列表组件
- [x] P7-T10：实现委托/成交列表组件
- [x] P7-T11：对接后端 API（替换 mock）
- [x] P7-T12：响应式布局适配
...
- [x] 前端可运行 `npm run dev` 启动
- [x] 交易界面可展示 K 线图表
- [x] 下单表单可提交（对接 mock API）
- [x] 订单簿可实时更新（mock 数据）
